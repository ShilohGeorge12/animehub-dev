		...
		<>
			...
			{errorMessage.length > 0 && !isErrorMsgModalOpen && (
				<button
					type='button'
					name={`view errors`}
					className={`bg-red-500 rounded-xl p-1 absolute top-16 right-2 md:top-35 md:right-1/4 text-2xl md:text-4xl animate-bounce hover:shadow-lg transition duration-500 ease-in-out hover:shadow-red-500`}
